...
//collapsToolbar.setBackgroundDrawable();
        try {
            ...
            TextView ftname = (TextView)findViewById(R.id.ftname);
            ftname.setText(objStudData.getString("father_name"));

            TextView mother_n = (TextView)findViewById(R.id.mother_n);
            mother_n.setText(objStudData.getString("mother_name"));
